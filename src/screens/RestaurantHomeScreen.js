          ...
          {restauratsData[id].discount && (
            <View style={styles.view1}>
              <Text style={styles.text1}>
                GET {restauratsData[id].discount}% OFF ON FOOD TOTAL
              </Text>
            </View>
          )}
          <View style={styles.view2}>
            <View style={styles.view3}>
              <Text style={styles.text2}>
                {restauratsData[id].restaurantName}
              </Text>
              ...
              <View style={styles.view4}>
                ...
                <Text style={styles.text4}>
                  {restauratsData[id].averageReview}
                </Text>
                <Text style={styles.text5}>
                  {restauratsData[id].numberOfReview}
                </Text>
                <Icon
                  name="map-marker"
                  type="material-community"
                ...
                <Text style={styles.text6}>
                  {restauratsData[id].farAway} Km away
                </Text>
              </View>
            </View>
            <View style={styles.view5}>
              <Text style={styles.text66}>Collect</Text>
              <View style={styles.view7}>
                <Text style={styles.text7}>
                  {restauratsData[id].collectTime}
                </Text>
                <Text style={styles.text8}>min</Text>
              </View>
            </View>
            <View style={styles.view8}>
              <Text style={styles.text66}>Delivery</Text>
              <View style={styles.view9}>
                <Text style={styles.text9}>
                  {restauratsData[id].deliveryTime}
                </Text>
...
const styles = StyleSheet.create({
  ...
  text66: {fontSize: 15, fontWeight: 'bold', color: colors.grey1},
